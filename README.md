...
<span style={{  color: '#fff', backgroundColor: '#ff4400', borderRadius: '9999px', padding: '2px 6px'  }}>{violation.severity}</span>
...
<p style={{  textAlign: 'center', fontSize: '16px', fontWeight: 'bold'  }}>No accessibility violations found.</p>
