...
const waxConfig = require('../../waxConfig.js').default;

describe('Vue App Accessibility Tests with WebdriverIO + Wax', () => {
    beforeEach(async () => {
        await browser.url('/');
    });
    ...
    it('should have no accessibility violations for main app', async () => {
        ...
        console.log('violations webdriverio vue', violations);
