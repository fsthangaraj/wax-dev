...
describe('Astro App Accessibility Tests with Vitest + Wax', () => {
  let violations;
  let astroHTML;
  ...
  beforeEach(async () => {
    try {
      ...
      if (bodyMatch) {
        ...
        console.log('bodyHTML vitest astro', bodyHTML)
  ...
  it('should detect accessibility violations for main app', () => {
    console.log('Vitest wax violations from REAL app:', violations);
